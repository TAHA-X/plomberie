                                              ...
                                              if (isset($_POST['sendEmailSubBtn'])) {
                                                 ...
                                                 if (
                                                    ...
                                                    if (mysqli_query($conn, $sqls)) {
                                                       ...
                                                       /***************send email**********************/
                                                       $to = 'hvnet@societe-plomberie-maroc.com';
                                                       $subject = 'DEMANDE DE DEVIS HVNET PLOMBERIE';
                                                       $headers = 'From: HVNET PEINTURE';
                                                       $cntsendmail = "
                                                                   Name          : $Name
                                                                   Ville         : $vlVille
                                                                   Tel           : $Tel
                            ...
                            <div class="col-lg-4 col-md-4 col-xs-12 col-sm-6">
                                ...
                                <div class="content-box-info" style="text-align: left;">
                                    ...
                                    <ul class="check-list why">
                                        <li><a href="reparation-fuite-eau-casablanca.html">Reparation fuite d'eau à Casablanca</a></li>
                                        <li><a href ="remplacement-chauffe-eau-electrique-casablanca.html">Chauffe eau electrique à Casablanca</a></li>
                                        <li><a href ="debouchage-wc-casablanca.html">Debouchage WC à Casablanca</a></li>
                                        <li><a href ="broyeur-casablanca.html">Broyeur à Casablanca</a></li>
                                        <li><a href ="debouchage-machine-laver-casablanca.html">Debouchage machine à laver à casablanca</a></li>
                                        <li><a href ="depannage-plomberie-casablanca.html">Depannage plomberie à casablanca</a></li>
                                        <li><a href ="debouchage-canalisation-casablanca.html">Debouchage canalisation à casablanca</a></li>
                                        <li><a href ="remplacement-robinet-casablanca.html">Remplacement robinet à casablanca</a></li>
                                        <li><a href ="ballon-eau-chaude-casablanca.html">Ballon d'eau chaude à casablanca</a></li>
                                        <li><a href ="urgence-plombier-casablanca.html">Urgence plombier à casablanca</a></li>
                                        <li><a href ="installation-chaudiere-casablanca.html">Installation chaudiere à casablanca</a></li>
                                        <li><a href ="installation-plomberie-casablanca.html">Installation de plomberie à casablanca</a></li>
